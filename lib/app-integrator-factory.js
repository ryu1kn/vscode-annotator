...
class AppIntegratorFactory {
    ...
    create() {
        ...
        const gitAnnotationContentGenerator = new GitAnnotationContentGenerator({
            gitAnnotationHtmlDirectorFactory, gitBlameOutputParser, gitService
        });
        ...
        const changedFileListParser = new ChangedFileListParser();
        const commands = vscode.commands;
        const switchDiffCommand = new SwitchDiffCommand({
            logger, uriService, gitService, changedFilePicker, changedFileListParser, commands
        });
