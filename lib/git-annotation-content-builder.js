...
class GitAnnotationContentBuilder {
        ...
        return [
            ...
            '<div class="line">',
                '<div class="annotation truncate">',
                    this._getLink(lineBlame.commitHash, lineBlame.filename, repositoryRootPath), '&nbsp;',
    ...
    _getLink(commitHash, filePath, repositoryRootPath) {
        const args = [commitHash, filePath, repositoryRootPath];
