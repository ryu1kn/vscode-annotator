...
class AnnotationStyleBuilder {
    ...
    _getFixedStyle() {
        ...
        const annotationCommitColorBandWidth = config.getExtensionConfig('annotationCommitColorBandWidth');
        ...
        return `
            * {
            ...
            .commitColor {
                min-width: ${annotationCommitColorBandWidth};
                max-width: ${annotationCommitColorBandWidth};
                margin: 0 1em 0 .5em;
            }
        `;
    }
