...
class App {
    ...
    takeDiff(lineBlame, repositoryRoot) {
        const uriBefore = this._getUri(lineBlame.previousCommitHash, lineBlame.previousFilename, repositoryRoot);
    ...
    _getUri(commitHash, filePath, repositoryRoot) {
        ...
        return this._vscode.Uri.parse(`annotation:${filePath}?${qs}`);
    }
